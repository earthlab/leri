...
#'
#' # multi-day example that will return a one-layer raster
#' r <- get_leri(date = c("2018-08-13", "2018-08-14"), product = "8 day nac")
#' names(r) # has one element (the layer covers August 13 to August 20)
#'
